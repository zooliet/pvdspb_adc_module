...
void usage(void)
{
	printf("i2cw bus_id dev_id reg_addr data\n");
	exit(EXIT_FAILURE);
}
...
void _make_write_arg(unsigned short dev_addr,unsigned char reg_addr,unsigned short data_len,unsigned char value)
{
struct i2c_msg *msg;
...
int							res;
	...
	_make_write_arg(dev_id,reg_addr,data_len,value);
